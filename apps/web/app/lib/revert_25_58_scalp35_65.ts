...
const SIGNAL_THRESHOLD = 25; // Minimum score — require stronger indicator alignment
const MIN_CONFIDENCE = 58; // Below 65% is noise — need real conviction to trade
...
const MIN_DIRECTIONAL_EDGE = 8; // Bigger gap between buy/sell to avoid choppy entries
