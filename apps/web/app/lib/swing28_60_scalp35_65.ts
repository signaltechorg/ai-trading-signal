...
const SIGNAL_THRESHOLD = 28; // Minimum score — require stronger indicator alignment
const MIN_CONFIDENCE = 60; // Below 65% is noise — need real conviction to trade
...
const SIGNAL_THRESHOLD_SCALP = 35;
const MIN_CONFIDENCE_SCALP = 65;
...
const MIN_DIRECTIONAL_EDGE = 10; // Bigger gap between buy/sell to avoid choppy entries
...
export const __debug = { scoreIndicators, calculateATR, analyzeMarketQuality, passesDirectionGate, getThresholds };
