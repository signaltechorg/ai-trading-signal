...
export const TIER_DEFINITIONS: TierDefinition[] = [
  ...
  },
  {
    ...
    features: [
      'Instant signals — no 15-minute delay between move and notification',
      'Every traded pair — FX, crypto, gold/silver, oil, US mega-caps, indices',
      'Confluence-gated entries — multiple indicators must align across H1/H4/D1 before firing',
      'Full risk levels (TP1, TP2, TP3, Stop Loss) — know your exit before you enter',
      'Private Pro Telegram — signals delivered while the move is still alive',
      'Unlimited history for your own backtests and audit trails',
      'Verify every entry and outcome in our public Postgres archive',
